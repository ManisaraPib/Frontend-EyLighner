<template>
    <div class="fixed flex w-full bg-gradient-to-r from-navbar1 to-navbar2 animated"
        ...
        ">
          ...
          ">
                    <div class="flex items-center justify-between flex-wrap">
                        <img src="../image/logo.png" class="eln-logo" />
                        <span class="px-3">EyLighner</span>
                    </div>
                </router-link>
                <!-- <p class="text-white font-semibold md:text-base">Eye alignment</p>
                <div class="box bg-white px-0.5 py-3"></div> -->
